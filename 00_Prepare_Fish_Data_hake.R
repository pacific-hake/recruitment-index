...
fish = data.frame(read.table(paste0(MainFile,'/00_Data/hake.data_raw.csv'), header=TRUE, sep=",", stringsAsFactors = FALSE))
...
devs = data.frame(read.table(paste0(MainFile,'/00_Data/HakeRecDevs_2020_medians.csv'), header=TRUE, sep=","))
...
write.csv(fish.out2,'hake.data_2020_medians.csv')
